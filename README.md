...
- Business logic violations: check for issues in the data itself, e.g. negative revenue, event session durations that are less than 0 seconds, and even order revenues that exceed a certain amount (~$5000) that could be flagged as potential fraud
